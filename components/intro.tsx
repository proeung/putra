...
const Intro = () => {
  return (
    <section className="container mx-auto px-5 w-full mb-16 md:mb-28 mt-40">
      <div className="max-w-2xl">
        ...
        <p className="mt-6 text-lg text-zinc-600 dark:text-zinc-400">
          I’m Putra, a software designer and entrepreneur based in South Jersey/Philadelphia.
          I’m the co-founder of OffRed, where we develop technologies that
